    ...
    execute: () => {
      vitest_1.describe('formatErrorMessage', () => {
        vitest_1.it('should format TimeoutError', () => {
          ...
          vitest_1
            .expect(errors_1.formatErrorMessage(error))
        ...
        vitest_1.it('should format HTTP status 503 from message', () => {
          ...
          vitest_1
            .expect(errors_1.formatErrorMessage(error))
            .toBe('Service unavailable. Please try again later.')
        })
        vitest_1.it('should format HTTP status 504 from message', () => {
          ...
          vitest_1
            .expect(errors_1.formatErrorMessage(error))
            .toBe('Server took too long to respond. Please try again.')
        })
        ...
        vitest_1.it('should handle null', () => {
          vitest_1
            .expect(errors_1.formatErrorMessage(null))
            .toBe('An unexpected error occurred. Please try again.')
        })
        vitest_1.it('should handle undefined', () => {
          vitest_1
            .expect(errors_1.formatErrorMessage(undefined))
            .toBe('An unexpected error occurred. Please try again.')
        })
