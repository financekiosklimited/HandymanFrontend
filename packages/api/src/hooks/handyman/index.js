System.register(["@tanstack/react-query", "../../client", "./useDirectOffers"], function (exports_1, context_1) {
    "use strict";
        ...
        return react_query_1.useInfiniteQuery({
            ...
            queryFn: async ({ pageParam = 1 }) => {
                try {
                    ...
                    if (params?.city)
                        searchParams.set('city_id', params.city);
                    if (params?.latitude)
    ...
    function useStartWorkSession() {
        ...
        return react_query_1.useMutation({
            mutationFn: async ({ jobId, data }) => {
                ...
                if (data.start_accuracy)
                    formData.append('start_accuracy', data.start_accuracy.toFixed(2));
    ...
    function useStopWorkSession() {
        ...
        return react_query_1.useMutation({
            mutationFn: async ({ jobId, sessionId, data, }) => {
                ...
                if (data.end_accuracy)
                    formData.append('end_accuracy', data.end_accuracy.toFixed(2));
