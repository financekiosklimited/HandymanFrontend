...
import type { PaginatedArrayResponse, ApiResponse, HomeownerJob, HomeownerHandyman, HomeownerProfile, HomeownerProfileUpdateRequest, Notification } from '../../types/homeowner'
 ...
 */
export function useHomeownerUnreadCount(enabled: boolean = true) {
  return useQuery({
