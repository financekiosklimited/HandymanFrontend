  ...
  (exports_1, context_1) => {
    ...
    function useHomeownerJob(publicId) {
      return react_query_1.useQuery({
        ...
        queryFn: async () => {
          const response = await client_1.apiClient.get(`homeowner/jobs/${publicId}/`).json()
    ...
    function useHomeownerHandyman(publicId) {
      return react_query_1.useQuery({
        ...
        queryFn: async () => {
          const response = await client_1.apiClient.get(`homeowner/handymen/${publicId}/`).json()
          return response.data
        },
        enabled: !!publicId,
      })
    ...
    function useHomeownerProfile() {
      return react_query_1.useQuery({
        ...
        queryFn: async () => {
          const response = await client_1.apiClient.get('homeowner/profile').json()
          return response.data
        },
      })
    }
    ...
    function useUpdateHomeownerProfile() {
      ...
      return react_query_1.useMutation({
        mutationFn: async (data) => {
          const response = await client_1.apiClient.put('homeowner/profile', { json: data }).json()
          return response.data
        },
        onSuccess: () => {
    ...
    function useMarkAllHomeownerNotificationsRead() {
      ...
      return react_query_1.useMutation({
        mutationFn: async () => {
          const response = await client_1.apiClient.post('homeowner/notifications/read-all/').json()
          return response.data
        },
        onSuccess: () => {
          queryClient.invalidateQueries({ queryKey: ['homeowner', 'notifications'] })
    ...
    function useHomeownerWorkSessions(jobId) {
      return react_query_1.useQuery({
        ...
        queryFn: async () => {
          const response = await client_1.apiClient.get(`homeowner/jobs/${jobId}/sessions/`).json()
          return response.data || []
        },
        enabled: !!jobId,
      })
    ...
    function useHomeownerDailyReports(jobId) {
      return react_query_1.useQuery({
        ...
        queryFn: async () => {
          const response = await client_1.apiClient.get(`homeowner/jobs/${jobId}/reports/`).json()
          return response.data || []
        },
        enabled: !!jobId,
      })
    ...
    function useHomeownerDisputes(jobId) {
      return react_query_1.useQuery({
        ...
        queryFn: async () => {
          const response = await client_1.apiClient.get(`homeowner/jobs/${jobId}/disputes/`).json()
          return response.data || []
        },
        enabled: !!jobId,
      })
    ...
    function useReviewReimbursement() {
      ...
      return react_query_1.useMutation({
        mutationFn: async ({ jobId, reimbursementId, data }) => {
          const response = await client_1.apiClient
            .post(`homeowner/jobs/${jobId}/reimbursements/${reimbursementId}/review/`, {
              json: data,
            })
            .json()
          return response.data
