System.register(
  ...
  (exports_1, context_1) => {
    ...
    function useLogin() {
      ...
      return react_query_1.useMutation({
        mutationFn: async (data) => {
          const response = await client_1.apiClient.post('auth/login', { json: data }).json()
          if (!response.data) {
    ...
    function useRefreshToken() {
      ...
      return react_query_1.useMutation({
        mutationFn: async (data) => {
          const response = await client_1.apiClient.post('auth/refresh', { json: data }).json()
          if (!response.data) {
    ...
    function useRegister() {
      ...
      return react_query_1.useMutation({
        mutationFn: async (data) => {
          const response = await client_1.apiClient.post('auth/register', { json: data }).json()
          if (!response.data) {
    ...
    function useVerifyEmail() {
      ...
      return react_query_1.useMutation({
        mutationFn: async (data) => {
          const response = await client_1.apiClient.post('auth/email/verify', { json: data }).json()
          if (!response.data) {
    ...
    function useResendVerificationEmail() {
      return react_query_1.useMutation({
        mutationFn: async (data) => {
          const response = await client_1.apiClient.post('auth/email/resend', { json: data }).json()
          return response
        },
      })
    }
