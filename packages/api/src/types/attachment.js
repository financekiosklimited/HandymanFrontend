...
System.register([], function (exports_1, context_1) {
    "use strict";
    var IMAGE_MIME_TYPES, VIDEO_MIME_TYPES, DOCUMENT_MIME_TYPES, UNSUPPORTED_IMAGE_EXTENSIONS, UNSUPPORTED_IMAGE_MIME_TYPES, ATTACHMENT_LIMITS;
    ...
    return {
        setters: [],
        execute: function () {// Unified attachment types for multi-type file support (images, videos, documents)
            // MIME type mappings for file type detection
            exports_1("IMAGE_MIME_TYPES", IMAGE_MIME_TYPES = [
                'image/jpeg',
                'image/png',
                'image/gif',
                'image/webp',
            ...
            exports_1("VIDEO_MIME_TYPES", VIDEO_MIME_TYPES = [
                'video/mp4',
                'video/quicktime',
                'video/x-m4v',
                'video/webm',
            ...
            exports_1("DOCUMENT_MIME_TYPES", DOCUMENT_MIME_TYPES = [
                'application/pdf',
                'application/msword',
            ...
            exports_1("UNSUPPORTED_IMAGE_EXTENSIONS", UNSUPPORTED_IMAGE_EXTENSIONS = [
            ...
            exports_1("UNSUPPORTED_IMAGE_MIME_TYPES", UNSUPPORTED_IMAGE_MIME_TYPES = [
                'image/x-adobe-dng',
                'image/x-dcraw',
                'image/x-canon-cr2',
                'image/x-canon-cr3',
            ...
            // ========== Upload Limits ==========
            exports_1("ATTACHMENT_LIMITS", ATTACHMENT_LIMITS = {
                chat: {
                    maxCount: 5,
