  ...
  (exports_1, context_1) => {
    ...
    return {
      ...
      execute: () => {
        ...
        exports_1(
          'getAuthStore',
          (getAuthStore = zustand_1.create()(
            middleware_1.persist(
              (set) => ({
                // Initial state
                accessToken: null,
                refreshToken: null,
        ...
        exports_1(
          'useIsAuthenticated',
          (useIsAuthenticated = () => getAuthStore((state) => state.isAuthenticated))
        )
        exports_1(
          'useActiveRole',
          (useActiveRole = () => getAuthStore((state) => state.activeRole))
        )
        exports_1(
          'useAccessToken',
          (useAccessToken = () => getAuthStore((state) => state.accessToken))
        )
      },
    }
  }
