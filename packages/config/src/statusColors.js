System.register([], (exports_1, context_1) => {
  let jobStatusColors
  let applicationStatusColors
  let getJobStatusColor
  let getApplicationStatusColor
  let directOfferStatusColors
  let getDirectOfferStatusColor
  let timeUrgencyColors
  let getTimeUrgencyColor
  ...
  return {
    ...
    execute: () => {
      ...
      exports_1(
        'getDirectOfferStatusColor',
        (getDirectOfferStatusColor = (status) => {
