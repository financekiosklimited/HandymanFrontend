...
/**
 * Deep link handler for Stripe Identity verification return.
 * Route: handymankiosk://kyc/identity/return
 *
 * The user completed or exited the Stripe Identity verification flow.
 * Invalidate KYC queries and redirect to KYC status screen.
 */
