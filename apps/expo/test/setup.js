    ...
    return {
        ...
        execute: function () {
            ...
            vitest_1.vi.mock('expo-image-picker', () => ({
                requestMediaLibraryPermissionsAsync: vitest_1.vi.fn(() => Promise.resolve({ granted: true })),
            ...
            vitest_1.vi.mock('expo-location', () => ({
                requestForegroundPermissionsAsync: vitest_1.vi.fn(() => Promise.resolve({ status: 'granted' })),
                getCurrentPositionAsync: vitest_1.vi.fn(() => Promise.resolve({
                    coords: {
                        latitude: 37.7749,
                        longitude: -122.4194,
                    },
